...
export default function HomePage() {
  ...
  // Modal States
  const [selectedToyForDetail, setSelectedToyForDetail] = useState<any>(null);
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1 }}>
        ...
        <ExchangeFeed
          ...
          searchTerm={searchTerm}
          setSearchTerm={setSearchTerm}
          onSelectToy={(toy: any) => setSelectedToyForDetail(toy)}
          onRequestSwap={(toy: any) => setSelectedToyForDetail(toy)}
        />
