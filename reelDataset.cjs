/**
 * @file reelDataset.cjs
 * @description CommonJS Module containing the @ojas_met_krishna reel dataset, schema definitions,
 * and utility query helpers for integration with Node.js CommonJS backends or scripts.
 */

const reelData = require('./reelDataset.json');
 ...
 */
function getReelsByAgeMonths(ageMonths) {
 ...
 * @returns {Array} Array of matching reels
 */
function getReelsBySkill(skillId) {
  return reelData.reels.filter(reel => 
 ...
 * @returns {Array} Array of matching reels
 */
function getReelsBySubLocality(subLocality) {
 ...
 */
function getReelByManyChatKeyword(keyword) {
...
module.exports = {
  ...
  getReelsByAgeMonths,
  getReelsBySkill,
  getReelsBySubLocality,
  getReelByManyChatKeyword
};
